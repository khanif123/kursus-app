    ...
    <main className="min-h-screen px-6 py-10 max-w-md mx-auto">
      ...
      {['admin', 'super_admin', 'teacher'].includes(profile?.role) && (
        <Link
          ...
          className="block bg-mustard/15 border border-mustard/40 rounded-xl p-4 text-center font-medium text-pineDark mb-8 hover:bg-mustard/25 transition-colors"
        >
          Buka Panel Admin
        </Link>
      )}
